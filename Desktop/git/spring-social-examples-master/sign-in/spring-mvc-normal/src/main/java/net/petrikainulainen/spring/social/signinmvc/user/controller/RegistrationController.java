...
public class RegistrationController {
    ...
    public String showRegistrationForm(WebRequest request, Model model ,ModelAndView mav ,RedirectAttributes redirectAttributes) {
        LOGGER.debug("Rendering registration page.");
        Connection<?> connection = ProviderSignInUtils.getConnection(request);
        String socialtype = connection.getKey().getProviderId();
        if(socialtype != null && "TWITTER".equalsIgnoreCase(socialtype)){
        	redirectAttributes.addFlashAttribute("twitter", connection);
            return "redirect:/twitter/api";
        }else if (socialtype != null && "FACEBOOK".equalsIgnoreCase(socialtype)){
        	redirectAttributes.addFlashAttribute("facebook", connection);
            return "redirect:/facebook/api";        
        }else if (socialtype != null && "LINKEDIN".equalsIgnoreCase(socialtype)){
        	redirectAttributes.addFlashAttribute("linkedin", connection);
            return "redirect:/linkedin/api";        
        }else if (socialtype != null && "GOOGLE".equalsIgnoreCase(socialtype)){
        	redirectAttributes.addFlashAttribute("google", connection);
            return "redirect:/google/api";        
        }
